<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\bis\detail.html";i:1498724407;s:78:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\public\header.html";i:1497680203;s:78:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\public\footer.html";i:1497684277;}*/ ?>
...
<article class="page-container">
  <form class="form form-horizontal" >
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <script id="editor1"  type="text/plain" name="description" style="width:80%;height:300px;"><?php echo html_entity_decode($bisData['description']); ?></script>
      </div>
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-3">
        <input type="text" class="input-text" value="<?php echo $accountData['contact']; ?>" placeholder="" id="" name="contact">
      </div>
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-3">
        <input type="text" class="input-text" value="<?php echo $locationData['address']; ?>" placeholder="" id="" name="address">
      </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-3">
        <input type="text" class="input-text" value="<?php echo $accountData['open_time']; ?>" placeholder="" id="" name="open_time">
      </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <script id="editor"  type="text/plain" name="content" style="width:80%;height:300px;"><?php echo $accountData['content']; ?></script>
      </div>
    </div>
