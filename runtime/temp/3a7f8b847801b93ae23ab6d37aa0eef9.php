<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\productlist\add.html";i:1498800216;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form action="<?php echo url('productlist/add'); ?>" method="post" enctype="multipart/form-data">
        <div class="row cl">
