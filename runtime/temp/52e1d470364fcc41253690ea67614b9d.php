<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\wamp\www\thinkphp_5.0.9\public/../application/index\view\login\login.html";i:1498548894;}*/ ?>
...
<div class="centBox">
	<div class="top">
    	<span>【<a href="#">登陆管理</a> 】 【<a href="<?php echo url('login/reg'); ?>">申请入驻</a>】  【<a href="#">前往采购</a>】  【<a href="#">联系我们</a>】</span>
 ...
 <form  action="" method="post">
  ...
  <tr>
    ...
    <td><p><input name="" type="checkbox" value="" />十天免费登录</p></td>
            ...
            <div class="zhece">
       		<span class="zhece_spa">还不是义乌购用户？</span><a href="<?php echo url('login/reg'); ?>">免费注册</a>            </div>
            <div class="zhano">
            	<span class="l">其他用户登录：</span><a href="#"><img src="images/qq.gif" /></a>            </div>
        </div>
    </div>
	</form>
</div>
