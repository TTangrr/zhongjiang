<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\wamp\www\thinkphp_5.0.9\thinkphp_5.0.9\public/../application/admin\view\bis\apply.html";i:1498643289;s:93:"D:\wamp\www\thinkphp_5.0.9\thinkphp_5.0.9\public/../application/admin\view\public\header.html";i:1497680203;s:93:"D:\wamp\www\thinkphp_5.0.9\thinkphp_5.0.9\public/../application/admin\view\public\footer.html";i:1497684277;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
  ...
  <div class="mt-20">
	<table class="table table-border table-bordered table-bg table-hover table-sort">
	  ...
	  <tr class="text-c">
		...
		<td class="td-manage">
			<a style="text-decoration:none" class="ml-5" onClick="o2o_edit('商户入驻详情数据','<?php echo url('bis/detail', ['id'=>$vo['id']]); ?>')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
			...
			<a style="text-decoration:none" class="ml-5"  href="<?php echo url('bis/status',['id'=>$vo['id'], 'status'=>2]); ?>" title="不通过"><i class="Hui-iconfont">不通过</i></a></td>
	  </tr>
  ...
  <div class="tp5-o2o pagination"><?php echo $bis->render(); ?></div>
