<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\productlist\edit.html";i:1499217028;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	<meta charset="utf-8">
	...
	<form action="<?php echo url('productlist/edit'); ?>" method="post" enctype="multipart/form-data">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<img id="upload_org_code_img" src="<?php echo $oldlist->logo; ?>" width="150" height="150">
