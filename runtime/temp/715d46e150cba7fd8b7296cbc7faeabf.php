<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\category\index.html";i:1499068610;s:78:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\public\header.html";i:1499091683;s:78:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\public\footer.html";i:1497684277;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tr class="text-c">
				...
				<td class="text-c listorder1"><input size="3" attr-id="<?php echo $vo['id']; ?>"  name="listorder" value="<?php echo $vo['listorder']; ?>"/></td>
