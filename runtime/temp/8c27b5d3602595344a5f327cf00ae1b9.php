<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\wamp\www\thinkphp_5.0.9\public/../application/index\view\user\login.html";i:1499093860;}*/ ?>
 ...
 <form  action="<?php echo url('user/logincheck'); ?>" method="post">
  ...
  <tr>
    ...
    <td><p><input name="" type="checkbox" value="" />十天免费登录</p></td>
            ...
            <div class="zhece">
       		<span class="zhece_spa">还不是义乌购用户？</span><a href="<?php echo url('user/reg'); ?>">免费注册</a>            </div>
            <div class="zhano">
