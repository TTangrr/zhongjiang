<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\product\category.html";i:1498143957;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<!--[if IE 6]>
<script type="text/javascript" src="lib/admin/DD_belatedPNG_0.0.8a-min.js" ></script>
...
<table class="table">
	<tr>
		...
		<td class="va-t"><iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=390px SRC="<?php echo url('product/categoryAdd'); ?>"></iframe></td>
	</tr>
</table>
<!--_footer 作为公共模版分离出去-->
