<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\member\index.html";i:1498197112;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="text-c"> 日期范围：
		<input type="text" onfocus="WdatePicker({ maxDate:$('datemax').val()||'%y-%M-%d'})" id="datemin" class="input-text Wdate" style="width:120px;">
		-
		<input type="text" onfocus="WdatePicker({ maxDate:$('datemax').val()||'%y-%M-%d'})" id="datemax" class="input-text Wdate" style="width:120px;">
