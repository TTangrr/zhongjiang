<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\wamp\www\thinkphp_5.0.9\public/../application/index\view\product\product.html";i:1499400895;s:79:"D:\wamp\www\thinkphp_5.0.9\public/../application/index\view\publics\header.html";i:1499335776;s:79:"D:\wamp\www\thinkphp_5.0.9\public/../application/index\view\publics\footer.html";i:1498139237;}*/ ?>
        ...
        <div class="neiyeL">
            ...
            <div class="dianhua">
                ...
                <div class="dianhua_text">
                    联  系  人：陈波 （总裁） <br />
                    电       话 ：86 0838 7102727999999999999999999999<br />
                ...
                <div class="product_top">
                    ...
                    <div class="product_info">
                        ...
                        <p class=" prod_pad">
                            ...
                            <input name=""  type="text" class="prod_tetx" value="<?php echo $shangp['count']; ?>" />
...
<script>
   //
    $('#jian').click(function(){
        ...
        var url ="<?php echo url('product/product'); ?>";
		var total_count="<?php echo $shangp['total_count']; ?>";
        //alert(total_count);
       ...
       // alert(count);
		if(count<=total_count){
            ...
            var id="<?php echo $shangp['id']; ?>";
            var postDdata = {
                'id': id,
                'count': count,

            }
                $.get(url,postDdata,function(result){
                        //alert(result.data)
                        $(".prod_tetx").val(result.data);
