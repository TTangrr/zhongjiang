<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"D:\wamp\www\thinkphp_5.0.9\thinkphp_5.0.9\public/../application/admin\view\productlist\edit.html";i:1498800237;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	<meta charset="utf-8">
...
<div class="page-container">
	<form action="<?php echo url('productlist/edit'); ?>" method="post" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $oldlist['title']; ?>" placeholder="" id="" name="title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $oldlist['price']; ?>" placeholder="" id="" name="price">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">内容：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="content" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"><?php echo $oldlist['content']; ?></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<img style="display: none" id="upload_org_code_img" src="<?php echo $oldlist->logo; ?>" width="150" height="150">
	...
	$(function() {
		$(function() {
			...
			$("#file_upload").uploadify({
				...
				'buttonText': '图片上传',	//按钮提示
				'fileTypeDesc': 'Image files',	//文件类型
				'fileObjName': 'file',		//名字jiaofile
