<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"D:\wamp\www\thinkphp_5.0.9\thinkphp_5.0.9\public/../application/admin\view\login\login.html";i:1496974714;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <form class="form form-horizontal" action="" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="<?php echo captcha_src(); ?>" onclick="this.src=this.src+'?'+Math.random()"> <a id="kanbuq" href="javascript:;">看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
