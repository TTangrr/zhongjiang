<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\hangye\add.html";i:1498795797;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form action="<?php echo url('hangye/add'); ?>" method="post" enctype="multipart/form-data">
        <div class="row cl">
