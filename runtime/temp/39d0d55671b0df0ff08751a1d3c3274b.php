<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\wamp\www\thinkphp_5.0.9\public/../application/admin\view\picture\add.html";i:1498142513;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="" id="datemin" class="input-text Wdate">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>结束日期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="" id="datemax" class="input-text Wdate">
			</div>
		</div>
		<div class="row cl">
